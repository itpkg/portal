...
set :repo_url, 'https://github.com/itpkg/portal.git'
...
set :linked_dirs, fetch(:linked_dirs, []).push('log', 'tmp/pids', 'tmp/cache', 'tmp/sockets', 'vendor/assets/bower_components', 'public')
